...
import ru.sberbank.homework.gavrilov.SimpleCalculator;
...
public class SimpleCalculatorTest {
    ...
    public void testIntMaxValueAddZeroThenIntMaxValue() {
        int actual = SimpleCalculator.add(0, Integer.MAX_VALUE);
        int expected = Integer.MAX_VALUE;
        Assert.assertEquals("0 + 2147483647 is 2147483647", expected, actual);
    }
